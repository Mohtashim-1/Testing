...
def execute(filters=None):
	columns = [
		...
		{"label": "Absent On Missing", "fieldname": "mark_absent_on_missing", "fieldtype": "Data", "width": 200},
	]

	conditions = "WHERE ea.mark_absent_on_missing != 0 AND ea.employee != 'MOHTASHIM MUHAMMAD SHOAIB'"
	params = {}
