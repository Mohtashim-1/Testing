...
class EarlyOverTimeForm(Document):
	...
	def get_data(self):
		...
		where p.month=%s and p.year=%s and c.date=%s and c.early_ot is not null, c.early_over_time is not null and c.check_in_1 is not null and c.approved_eot is null""",
